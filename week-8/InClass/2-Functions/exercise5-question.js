...
let greeting1 = greet(firstName1, surname1); //"Hello " + firstName1 + " " + surname1;


let firstName2 = "Eric";
let surname2 = "Yuan";
// Change the line below to call your function!
let greeting2 = greet(firstName2, surname2);//"Hello " + firstName2 + " " + surname2;

let firstName3 = "Jeff";
let surname3 = "Bezos";
// Change the line below to call your function!
let greeting3 = greet(firstName3, surname3) //"Hello " + firstName3 + " " + surname3;
